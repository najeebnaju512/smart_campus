...
class _ProfilePageState extends State<ProfilePage> {
  fetchData() {
    Provider.of<ProfilePageController>(context, listen: false).fetchData(context);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Consumer<ProfilePageController>(builder: (context, controller, _) {
              ...
              : SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image: controller.profileModel.data?.image == null
                      ...
                      Column(
                        children: [
                          Text(
                            ...
                            style: TextStyle(fontFamily: "Nexa Bold", fontSize: 30, color: Colors.black),
                          ),
                          SizedBox(
                            height: 15,
                          ),
                      ...
                      Image.network(
                        "${AppConfig.mediaUrl}${controller.profileModel.data?.barcode}",height: 200,
                      ),
                      SizedBox(
                        height: 15,
                      ),
                      TextButton(
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => DoubtPage()));
                        },
                        child: Text(
